...
<%@page import="com.FlyAway.Data.Bookings"%>
<%@page import="com.FlyAway.Data.Passenger"%>
<%@page import="com.FlyAway.Data.Airport"%>
<%@page import="com.FlyAway.dao.FlyPassengerDao"%>
<%@page import="com.FlyAway.Data.Fare"%>
<%@page import="com.FlyAway.Data.Flight"%>
...
<body>
	...
	Flight flight = (Flight) session.getAttribute("flightobject");
			...
			Passenger customer = cust.getCustomer(customerId);
			Bookings reservation = cust.getBookings(bookingId);
	...
	<section class="mt-4">
		...
		<div class="container jumbotron py-2">
			<dl class="row pt-3">
				...
				<dd class="col-sm-9"><%=fare.getFlightClass()%></dd>
				...
				<dd class="col-sm-9">
					<dl class="row">
						<dt class="col-sm-4">passengerId:</dt>
						<dd class="col-sm-8"><%=customer.getPassengerId()%></dd>
						...
						<dd class="col-sm-8"><%=customer.getEmailId()%></dd>

						<dt class="col-sm-4">Phone Number:</dt>
						<dd class="col-sm-8"><%=customer.getContact()%></dd>
